...
export default function PublicAgentsListPage() {
  const query = useQuery({
    ...
    queryFn: () => apiGet<{ data: AgentCard[] }>('/ecosystem/agents'),
  });
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-8 sm:py-10">
        ...
        <p className="text-sm text-muted-foreground mt-2 mb-8">
          Агенты с опубликованными объявлениями на LiveGrid
        </p>
            ...
            {agents.map((a) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-semibold text-sm truncate">{a.name ?? 'Агент'}</p>
                  {a.title ? (
