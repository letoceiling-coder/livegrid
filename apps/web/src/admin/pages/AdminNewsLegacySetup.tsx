...
export default function AdminNewsLegacySetup() {
  ...
  return (
    <details className="mx-4 md:mx-6 mb-8 border rounded-2xl bg-muted/20">
      <summary className="cursor-pointer px-5 py-4 font-medium text-sm text-muted-foreground hover:text-foreground">
        Telegram MTProto, RSS и расширенный CRUD (legacy)
      </summary>
    <div className="p-6 max-w-5xl border-t">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <Newspaper className="w-6 h-6 text-primary" />
          <h2 className="text-lg font-bold">Дополнительные инструменты</h2>
