  ...
  apps: [
    {
      ...
      env: {
        ...
        FEED_IMPORT_PROCESSOR_ENABLED: pick('FEED_IMPORT_PROCESSOR_ENABLED', 'false'),
        TELEGRAM_NEWS_AUTO_SYNC_DISABLE: pick('TELEGRAM_NEWS_AUTO_SYNC_DISABLE', 'true'),
    ...
    },
    {
      name: 'lg-feed-worker',
      cwd: `${deployRoot}/apps/api`,
      script: 'dist/feed-import-worker.main.js',
      instances: 1,
      exec_mode: 'fork',
      env: {
        ...sharedEnv,
        FEED_IMPORT_PROCESSOR_ENABLED: 'true',
        FEED_IMPORT_CRON_REGISTER: 'false',
        TELEGRAM_NEWS_AUTO_SYNC_DISABLE: 'true',
      },
      max_memory_restart: '1536M',
      error_file: '/var/log/lg/feed-worker-error.log',
      out_file: '/var/log/lg/feed-worker-out.log',
      ...pm2Common,
    },
  ],
};
